...
class TaobaoEnvelopeActivity : BaseActivity(), SeekBar.OnSeekBarChangeListener {

    private val WECHAT_SERVICE_NAME = "com.example.redenvelopes/.service.TaobaoService"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_taobao_envelope)
    ...
    private fun initView() {
        ...
        mCbWechatControl.setOnCheckedChangeListener { buttonView, isChecked ->
            ...
            Toast.makeText(this@TaobaoEnvelopeActivity, "辅助功能找到（淘宝手机抢购）开启或关闭。", Toast.LENGTH_SHORT)
                .show()
        }
